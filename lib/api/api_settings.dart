class ApiSettings {
  ...
  static const String subCategory = '${_baseurl}sub-categories?{filters[category][\$eq]=}&&{populate=}';
  static const String bookList = '${_baseurl}courses?{filters[sub_category][\$eq]=}&&{populate=}';
  static const String courseDetails = '${_baseurl}courses/:documentId?populate=*';
